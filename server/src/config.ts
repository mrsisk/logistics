...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'logistics';
  ...
  'jhipster.mail.from' = 'logistics@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'logistics API';
  'jhipster.swagger.description' = 'logistics API documentation';
  ...
  'eureka.instance.appname' = 'logistics';
  'eureka.instance.instanceId' = 'logistics:${random.value}';
